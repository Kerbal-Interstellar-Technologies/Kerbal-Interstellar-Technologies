...
namespace KIT
{
    ...
    class KITGamePlayParams : KITDifficultyCustomParams
    {
        ...
        // [GameParameters.CustomFloatParameterUI("#LOC_KIT_DifficultyConfig_MinimumRTGOutput", toolTip = "#LOC_KIT_DifficultyConfig_MinimumRTGOutput_tip", minValue = 0.0f, maxValue = 0.10f, displayFormat = "F2")]
